...
class SimplePerceptron: 
    ...
    def train(self):
        ...
        while epsilonOnIteration > self.parameters.epsilon and iteratedEpochs < self.parameters.epochs:
            ...
            if self.mustShuffleLearningSet:
                trainingSet = self.parameters.getShuffledData()
    ...
    def collectEpochInformation(self, epoch, epsilon):
        self.errorInformation.add(epoch, epsilon) #TODO: Enviar mjes solo a training information, no acoplar con esta clase!
