...
def createOCR():
    ...
    fileNameToCreate = './workspaceFacu/RedesNeuronales-TP1/src/OCR/input_ocr.txt'
    #expectedOutputSource = 'C:\Facultad\RedesNeuronales\TP1\src\OCR\output - test.txt'
    expectedOutputSource = './workspaceFacu/RedesNeuronales-TP1/src/OCR/output - test.txt'
